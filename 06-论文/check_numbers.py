...
def main():
    ...
    for s in ("1.301", "R/L=8\\%", "6.25", "39", "1\\% 量级", "\\rho_{sv}=\\rho/(1+C)"):
        expect(f"定量声明 {s}", s)
    # ---- 力学升级（扩展研究）小节 ----
    for s in ("0.502", "1.135", "0.843", "0.161", "51.1667", "0.1052", "1.1751",
              "0.3345", "0.368/0.356/0.336/0.319/0.218", "0.636", "1.2027",
              "4.9\\times10^{-15}", "2.2\\times10^{-16}", "2.7\\times10^{-16}",
              "0.145", "1.717", "5.3\\times10^{-15}", "4.3\\times10^{-11}",
              "4.7\\times10^3", "3.3\\times10^6", "1.0\\times10^{-3}",
              "50.8873", "52.5496", "49.6667", "-0.047", "4.188", "0.042",
              "0.5\\%--1.3\\%", "59.33", "49.67", "0.70 mm", "0.537 mm",
              "0.568/0.572", "0.657", "0.185 cm", "1.393", "不再采用",
              "扩展研究", "不能声称\"力学模型复现附件 2\""):
        expect(f"力学升级 {s}", s)
